      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
              color: locked ? Colors.grey.shade300 : const Color(0xFFDBE0E6),
            ),
            boxShadow: [
              BoxShadow(
            ...
            children: [
              Stack(
                ...
                children: [
                  Icon(
                    icon,
                    size: 32,
                    color: locked ? Colors.grey : primaryColor,
                  ),
                  if (locked)
                    const Icon(
                      Icons.lock,
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.bold,
                  color: locked ? Colors.grey : textColor,
                ),
  ...
  Widget _buildApplicationStatusCard(BuildContext context) {
    return Consumer<ApplicationProvider>(
      builder: (context, appProvider, child) {
        ...
        final pendientes =
            apps.where((a) => a.estado.toLowerCase() == 'pendiente').length;
        final aprobadas = apps
            .where((a) =>
                a.estado.toLowerCase() == 'aceptada' ||
                a.estado.toLowerCase() == 'aprobada')
            .length;
        final rechazadas =
            apps.where((a) => a.estado.toLowerCase() == 'rechazada').length;
